...
import com.example.spring_boot_web_app.services.ProductService;
...
public class ProductController {
    ...
    public String createProduct(@RequestParam(value = "file1", required = false) MultipartFile file1, @RequestParam(value = "file2", required = false) MultipartFile file2,
                                @RequestParam(value = "file3", required = false) MultipartFile file3, Product product, Principal principal) throws IOException {
